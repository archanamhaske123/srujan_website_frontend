  ...
  <div class="container">
    <div id="arambh" class="row event-section program-flex  banner-content"
      ...
      <div class="col-lg-6 col-md-12 col-sm-12 program-padding">
        <h1>National Level Entrepreneurship Competition - ARAMBH Season-2</h1>
      </div>
      <div class="col-lg-6 col-md-12 col-sm-12 program-flex">
        <div class="program-cards program-cards-1">
          <p style="text-align: left!important;">Date & Time
            <br>Saturday, Sep 14, 2024
            <br>Time - 20.30 PM
          </p>
    ...
    <div class="row program-flex">
      <div class="col-lg-6 col-md-12 col-sm-12 program-padding">
        ...
        <p>The day commenced with an energetic registration process with 92 Students team and 59 Start-ups team
          ...
          National Entrepreneurship Competition lies not only in the impressive number of initial registrations, ranging
          from 1,700 to 1,800, but also in the quality and diversity of ideas presented. Lent the esteemed presence to
          lead not only the inaugural ceremony but also the inauguration of a vibrant exhibition featuring approximately
          56 stalls. The climax of the event unfolded with the declaration of results. The deserving students and
