  ...
  <div class="main-banner">
    ...
    <div class="container">
      ...
      <div class="banner-content banner-content-1">
        <h1>Fuel your innovation and turn ideas into reality</h1>
        <p>Empowering the next generation of entrepreneurs with cutting-edge resources, mentorship, and a dynamic
          environment to transform creative ideas into successful ventures.</p>
        <a href="#" class="explore-btn">Explore Programs</a>
      </div>
    </div>
  </div>
</section>
<section id="programs-we-offer" class="section-mt wow fadeInUp" data-wow-delay="0.6s">
  <div class="container" id="banner-common-design">
    <div class="row flex-container wow fadeInUp" data-wow-delay="0.5s">
      <div class="col-lg-12 col-md-12 col-sm-12 flex-title-heding">
        <div class="text-content">
          <h3 class="right-main-header">Programs We Offer</h3>
  ...
  <div class="container section-content-mt program-container-width wow fadeInUp" data-wow-delay="0.4s">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 programs-we-offer-flex">
...
<section id="facilities" class="section-mt facilities">
  ...
  <div class="container section-content-mt">
    <div class="row" style="margin: 0px;">
      <div class="col-lg-4 col-md-4 col-sm-12 program-cards-2 wow fadeInUp" data-wow-delay="0.6s"
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 program-cards-3 wow fadeInUp" data-wow-delay="0.6s"
        style="margin: 0px; padding: 0px;">
        <div class="program-cards ">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 program-cards-3 fadeInUp" data-wow-delay="0.8s"
        style="margin: 0px; padding: 0px;">
        <div class="program-cards ">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 program-cards-2 fadeInUp" data-wow-delay="0.8s"
        style="margin: 0px; padding: 0px;">
        <div class="program-cards">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 col-sm-12 let-mt-30">
        <a href="<?= base_url(); ?>contact-us/#contact-section"><span>Let’s Connect?</span> <img
            src="<?= base_url(); ?>assets/images/Arrow-icon.svg" alt=">Arrow-icon" class="image img-fluid">
        </a>
...
<section id="collaborations" class="collaborations ">
  <div class="container " id="banner-common-design">
    ...
    <div class="row flex-container wow fadeInUp section-content-mt" data-wow-delay="0.5s">
      <div class="col-lg-12 col-md-12 col-sm-12 flex-title-heding">
        <div class="text-content">
          <h3 class="right-main-header">Our Collaborations</h3>
          <p class="right-main-para">Life Changing Opportunities for our dear students</p>
        </div>
        <div class="text-img">
          <img src="<?= base_url(); ?>assets/images/Collabration-icon.svg" alt="Our Collaborations"
            class="image img-fluid">
        </div>
      </div>
  ...
  <div class="container section-content-mt  mb-5 wow fadeInUp" data-wow-delay="0.6s">
    <div id="our-collaborations-owl-carousel" class="owl-carousel owl-theme">
      ...
      <div class="item">
        <img src="<?= base_url(); ?>assets/images/sibdi-logo.svg" alt="sidbi">
      </div>
      <div class="item">
        <img src="<?= base_url(); ?>assets/images/pcsic-logo.svg" alt="pcsic">
      </div>
      <div class="item">
        <img src="<?= base_url(); ?>assets/images/Bhau-ins-logo.svg" alt="Bhau-ins">
      </div>
      <div class="item">
        <img src="<?= base_url(); ?>assets/images/infsp-logo.svg" alt="infspl">
      </div>
...
<section id="events" class="events section-mt">
  <div class="container" id="banner-common-design">
    <div class="row flex-container wow fadeInUp section-content-mt" data-wow-delay="0.5s">
      <div class="col-lg-12 col-md-12 col-sm-12 flex-title-heding">
        <div class="text-content">
          <h3 class="right-main-header">Events Held By SrujanHub</h3>
          <p class="right-main-para">Life Changing Opportunities for our dear students</p>
        </div>
        <div class="text-img">
    ...
    <div class="row g-5">
      <div class="col-lg-4 col-md-12 col-sm-12">
        <div class="event-card">
          ...
          <div class="p-3">
            <h5 class="event-title">National Level Entrepreneurship Competition: ARAMBH Season-1</h5>
            <p class="event-desc">Arambh, our endeavor to ignite ground-breaking start-up ideas, facilitates their
              transformation into feasible, pragmatic, and actionable solutions.</p>
      ...
      <div class="col-lg-4 col-md-12 col-sm-12">
        <div class="event-card">
          <img src="<?= base_url(); ?>assets/images/homepage-event-2.svg" alt="Festival of Start-up">
          <div class="p-3">
            <h5 class="event-title">Festival of Start-up 2023</h5>
            <p class="event-desc">The preliminary round of the Festival of Startup 2023, organized by Pimpri Chinchwad
              Startup Incubation Center, took place.</p>
      ...
      <div class="col-lg-4 col-md-12 col-sm-12">
        <div class="event-card">
          <img src="<?= base_url(); ?>assets/images/homepage-event-3.svg" alt="E-Summit">
          <div class="p-3">
            <h5 class="event-title">IIT Bombay 2024 – E-Summit</h5>
            <p class="event-desc">Srujan Entrepreneurship Development and Incubation Centre was privileged to
              participate in the prestigious IIT Bombay E-Summit as an incubator partner.</p>
